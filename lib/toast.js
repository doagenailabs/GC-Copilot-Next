window.showToast = function(message, toastId, duration = 5000) {
    ...
    const log = (message, ...args) => window.logger.log('toast', message, ...args);
    const error = (message, ...args) => window.logger.error('toast', message, ...args);
    const debug = (message, ...args) => window.logger.debug('toast', message, ...args);
