export function startGCSDKs(clientId) {
  return new Promise(async (resolve, reject) => {
    ...
    // Dynamically import the SDKs (use browser versions)
    let platformClient, ClientApp;
    try {
      console.log('GCCopilotNext - gcSDKs.js - Dynamically importing Genesys Cloud SDKs');
      platformClient = (await import('purecloud-platform-client-v2/dist/web/index.js')).default;
      ClientApp = (await import('purecloud-client-app-sdk/dist/purecloud-client-app-sdk.js')).default;
    ...
    try {
      ...
      // Expose platformClient and myClientApp on window for other modules
