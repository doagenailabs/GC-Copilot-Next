window.conversation = (function() {
    ...
    const log = (message, ...args) => window.logger.log('conversation', message, ...args);
    const error = (message, ...args) => window.logger.error('conversation', message, ...args);
    const debug = (message, ...args) => window.logger.debug('conversation', message, ...args);
